...
def option():
    ...
    parser.add_argument('--threads', type=int, default=1, help='number of threads for dataloader to use')
    ...
    # parser.add_argument('--data_train_lol_v1'       , type=str, default='/root/autodl-fs/HHVIDIFF/LOLdataset/LOLv1/train')
    ...
    # parser.add_argument('--data_val_lol_v1'         , type=str, default='/root/autodl-fs/HHVIDIFF/LOLdataset/LOLv1/val/low')
    ...
    # parser.add_argument('--data_valgt_lol_v1'       , type=str, default='/root/autodl-fs/HHVIDIFF/LOLdataset/LOLv1/val/high/')
